...
class MaxDepthVisitor {
  ...
  onOperationDefinitionEnter(operation) {
    ...
    if (depth > this.config.n) {
      const err = new graphql.GraphQLError(`Syntax Error: Query depth limit of ${this.config.n} exceeded, found ${depth}.`);
