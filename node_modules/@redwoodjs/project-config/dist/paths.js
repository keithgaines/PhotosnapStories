...
exports.resolveFile = exports.processPagesDir = exports.importStatementPath = exports.getPaths = exports.getBaseDirFromFile = exports.getBaseDir = exports.ensurePosixPath = void 0;
 ...
 */
const getBaseDir = (configPath = (0, _configPath.getConfigPath)()) => {
  return _path.default.dirname(configPath);
};
exports.getBaseDir = getBaseDir;
const getBaseDirFromFile = file => {
  return getBaseDir((0, _configPath.getConfigPath)(_path.default.dirname(file)));
};
...
const getPaths = (BASE_DIR = getBaseDir()) => {
  ...
  const {
    schemaPath
  } = (0, _config.getConfig)((0, _configPath.getConfigPath)(BASE_DIR)).api;
  ...
  const paths = {
    ...
    web: {
      ...
      html: _path.default.join(BASE_DIR, PATH_WEB_INDEX_HTML),
      config: _path.default.join(BASE_DIR, PATH_WEB_DIR_CONFIG),
      webpack: _path.default.join(BASE_DIR, PATH_WEB_DIR_CONFIG_WEBPACK),
      viteConfig: resolveFile(_path.default.join(BASE_DIR, PATH_WEB_DIR_CONFIG_VITE)),
