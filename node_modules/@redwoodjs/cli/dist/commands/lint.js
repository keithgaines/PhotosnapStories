...
const handler = async ({
  ...
  try {
    ...
    const result = await (0, _execa.default)('yarn eslint', (0, _filter.default)(_context = [fix && '--fix', !pathString && _fs.default.existsSync((0, _lib.getPaths)().web.src) && 'web/src', !pathString && _fs.default.existsSync((0, _lib.getPaths)().web.config) && 'web/config', !pathString && _fs.default.existsSync((0, _lib.getPaths)().scripts) && 'scripts', !pathString && _fs.default.existsSync((0, _lib.getPaths)().api.src) && 'api/src', pathString]).call(_context, Boolean), {
