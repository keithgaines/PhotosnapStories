...
var _web = require("@redwoodjs/internal/dist/build/web");
...
const handler = async ({
  ...
  const shouldGeneratePrismaClient = prisma && ((0, _includes.default)(side).call(side, 'api') || prerenderRoutes.length > 0);
  const tasks = (0, _filter.default)(_context = [shouldGeneratePrismaClient && {
    ...
    enabled: (0, _lib.getConfig)().web.bundler !== 'vite'
  }, (0, _includes.default)(side).call(side, 'web') && {
    title: 'Building Web...',
    task: async () => {
      if ((0, _lib.getConfig)().web.bundler === 'vite') {
        await (0, _web.buildWeb)({
          verbose
        });
      } else {
  ...
  try {
    await (0, _telemetry.timedTelemetry)(process.argv, {
      ...
      await jobs.run();
      if ((0, _includes.default)(side).call(side, 'web') && prerender) {
