...
const modelRelatedVariables = model => {
  var _context4, _context5, _context6, _context9, _context10, _context11, _context12, _context13;
  ...
  const relations = (0, _map.default)(_context4 = (0, _helpers.relationsForModel)(model)).call(_context4, relation => relation);
  const columns = (0, _map.default)(_context5 = (0, _filter.default)(_context6 = model.fields).call(_context6, field => field.kind !== 'object')).call(_context5, column => {
    var _context7;
    let validation;
    ...
    const isRelationalField = (0, _endsWith.default)(_context7 = column.name).call(_context7, 'Id') && (0, _some.default)(relations).call(relations, relation => {
      var _context8;
      return (0, _includes.default)(_context8 = column.name).call(_context8, relation);
    });
  ...
  const editableColumns = (0, _filter.default)(_context9 = (0, _filter.default)(columns).call(columns, column => {
    return (0, _indexOf.default)(NON_EDITABLE_COLUMNS).call(NON_EDITABLE_COLUMNS, column.name) === -1;
  })).call(_context9, filterAutoGeneratedColumnsForScaffold);
  ...
  const formattersImports = (0, _filter.default)(_context10 = (0, _sort.default)(_context11 = (0, _map.default)(columns).call(columns, column => column.displayFunction)).call(_context11)
  // filter out duplicates, so we only keep unique import names
  ).call(_context10, (name, index, array) => (0, _indexOf.default)(array).call(array, name) === index).join(', ');
  const listFormattersImports = (0, _filter.default)(_context12 = (0, _sort.default)(_context13 = (0, _map.default)(columns).call(columns, column => column.listDisplayFunction)).call(_context13)
  // filter out duplicates, so we only keep unique import names
  ).call(_context12, (name, index, array) => (0, _indexOf.default)(array).call(array, name) === index).join(', ');
  return {
    columns,
    fieldsToImport,
    editableColumns,
...
const routes = async ({
  ...
  const paramScaffoldPath = scaffoldPath === '' ? scaffoldPath : (0, _map.default)(_context14 = scaffoldPath.split('/')).call(_context14, _paramCase.paramCase).join('/') + '/';
...
const builder = yargs => {
  ...
  (0, _forEach.default)(_context15 = (0, _entries.default)(_helpers.yargsDefaults)).call(_context15, ([option, config]) => {
...
const splitPathAndModel = pathSlashModel => {
  var _context16;
  const path = (0, _slice.default)(_context16 = pathSlashModel.split('/')).call(_context16, 0, -1).join('/');
