...
const buildStringifiedScenario = async model => {
  ...
  return (0, _stringify.default)(scenario, (key, value) => {
...
const files = async ({
  ...
  const testFile = (0, _helpers.templateForComponentFile)({
    ...
    templateVars: {
      ...
      prismaImport: (0, _some.default)(_context3 = (await parseSchema(model)).scalarFields).call(_context3, field => field.type === 'Decimal'),
      prismaModel: model,
      ...rest
    }
  });
...
const builder = yargs => {
  ...
  (0, _forEach.default)(_context4 = (0, _entries.default)(defaults)).call(_context4, ([option, config]) => {
