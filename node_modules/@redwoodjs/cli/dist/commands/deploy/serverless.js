...
const handler = async yargs => {
  ...
  const dotEnvPath = _path.default.join(rwjsPaths.base, `.env.${yargs.stage}`);

  // Make sure .env.staging, .env.production, etc are loaded based on the --stage flag
  loadDotEnvForStage(dotEnvPath);
  const tasks = new _listr.Listr([...(0, _map.default)(_context = preRequisites(yargs)).call(_context, mapCommandsToListr), ...(0, _map.default)(_context2 = buildCommands(yargs)).call(_context2, mapCommandsToListr), ...(0, _map.default)(_context3 = deployCommands(yargs)).call(_context3, mapCommandsToListr)], {
    exitOnError: true,
  ...
  try {
    ...
    if (yargs.firstRun) {
      ...
      if (addDotEnv) {
        _fs.default.writeFileSync(dotEnvPath, `API_URL=${deployedApiUrl}`);
      ...
      if ((0, _includes.default)(_context4 = yargs.sides).call(_context4, 'web')) {
        ...
        console.log();
        const webDeployTasks = new _listr.Listr([
        // Rebuild web with the new API_URL
        ...(0, _map.default)(_context5 = buildCommands({
          ...yargs,
          sides: ['web'],
          firstRun: false
        })).call(_context5, mapCommandsToListr), ...(0, _map.default)(_context6 = deployCommands({
          ...yargs,
          sides: ['web'],
          firstRun: false
