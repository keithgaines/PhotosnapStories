...
const builder = async yargs => {
  ...
  .options(edgioBuilder).group((0, _keys.default)((0, _omit.default)(edgioBuilder, ['skip-init'])), 'Edgio deploy options:');
};
...
const ERR_MESSAGE_MISSING_CLI = buildErrorMessage('Edgio not found!', ['It looks like Edgio is not configured for your project.', 'Run the following to add Edgio to your project:', `  ${_colors.default.info('yarn add -D @edgio/cli')}`].join('\n'));
exports.ERR_MESSAGE_MISSING_CLI = ERR_MESSAGE_MISSING_CLI;
const ERR_MESSAGE_NOT_INITIALIZED = buildErrorMessage('Edgio not initialized!', ['It looks like Edgio is not configured for your project.', 'Run the following to initialize Edgio on your project:', `  ${_colors.default.info('yarn edgio init')}`].join('\n'));
