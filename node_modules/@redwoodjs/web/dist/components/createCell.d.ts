...
export type CellLoadingProps<TVariables extends OperationVariables = any> = {
    queryResult?: Partial<Omit<QueryOperationResult<any, TVariables>, 'loading' | 'error' | 'data'>>;
};
...
export type CellSuccessProps<TData = any, TVariables extends OperationVariables = any> = {
    queryResult?: Partial<Omit<QueryOperationResult<TData, TVariables>, 'loading' | 'error' | 'data'>>;
    updating?: boolean;
