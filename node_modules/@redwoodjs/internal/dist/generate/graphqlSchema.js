...
const generateGraphQLSchema = async () => {
  ...
  const loadSchemaConfig = {
    ...
    generates: {
      [(0, _projectConfig.getPaths)().generated.schema]: {
        plugins: ['schema-ast']
      }
    },
    silent: false,
  ...
  try {
    ...
    if (e instanceof Error) {
      ...
      const name = match?.[1];
      const schemaPrisma = _fs.default.readFileSync((0, _projectConfig.getPaths)().api.dbSchema);
      console.error('');
  ...
  const options = {
    ...
    filename: (0, _projectConfig.getPaths)().generated.schema,
    documents: []
  };
  if (loadedSchema) {
    try {
      const schema = await (0, _core.codegen)(options);
      _fs.default.writeFileSync((0, _projectConfig.getPaths)().generated.schema, schema);
      return (0, _projectConfig.getPaths)().generated.schema;
    } catch (e) {
