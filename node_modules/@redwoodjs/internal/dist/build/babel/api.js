...
exports.registerApiSideBabelHook = exports.prebuildApiFile = exports.getApiSideDefaultBabelConfig = exports.getApiSideBabelPresets = exports.getApiSideBabelPlugins = exports.getApiSideBabelConfigPath = exports.TARGETS_NODE = exports.BABEL_PLUGIN_TRANSFORM_RUNTIME_OPTIONS = void 0;
...
exports.TARGETS_NODE = TARGETS_NODE;
const getApiSideBabelPresets = ({
  ...
  var _context;
  return (0, _filter.default)(_context = ['@babel/preset-typescript',
...
exports.BABEL_PLUGIN_TRANSFORM_RUNTIME_OPTIONS = BABEL_PLUGIN_TRANSFORM_RUNTIME_OPTIONS;
const getApiSideBabelPlugins = ({
  ...
  ['babel-plugin-graphql-tag', undefined, 'rwjs-babel-graphql-tag'], [require('../babelPlugins/babel-plugin-redwood-import-dir').default, undefined, 'rwjs-babel-glob-import-dir'], openTelemetry && [require('../babelPlugins/babel-plugin-redwood-otel-wrapping').default, undefined, 'rwjs-babel-otel-wrapping']]).call(_context2, Boolean);
  return plugins;
};
exports.getApiSideBabelPlugins = getApiSideBabelPlugins;
const getApiSideBabelConfigPath = () => {
  const p = _path.default.join((0, _projectConfig.getPaths)().api.base, 'babel.config.js');
