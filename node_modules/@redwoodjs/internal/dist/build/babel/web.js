...
const getWebSideBabelPlugins = ({
  ...
  const commonPlugins = forVite ? [] : (0, _common.getCommonPlugins)();
  const plugins = (0, _filter.default)(_context = [...commonPlugins,
  ...
  }, 'rwjs-babel-src-alias'], [require('../babelPlugins/babel-plugin-redwood-directory-named-import').default, undefined, 'rwjs-directory-named-modules'],
...
const getWebSideBabelPresets = options => {
  ...
  return [['@babel/preset-react', reactPresetConfig], ['@babel/preset-env', {
  ...
  }, 'rwjs-babel-preset-env'], ['@babel/preset-typescript', undefined, 'rwjs-babel-preset-typescript']];
};
exports.getWebSideBabelPresets = getWebSideBabelPresets;
const getWebSideBabelConfigPath = () => {
  const customBabelConfig = _path.default.join((0, _projectConfig.getPaths)().web.base, 'babel.config.js');
...
const registerWebSideBabelHook = ({
  ...
  (0, _common.registerBabel)({
    ...defaultOptions,
    root: (0, _projectConfig.getPaths)().base,
