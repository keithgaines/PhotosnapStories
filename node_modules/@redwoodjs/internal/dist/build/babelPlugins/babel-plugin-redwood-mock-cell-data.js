  ...
  return {
    ...
    visitor: {
      ...
      ExportNamedDeclaration(p, state) {
        ...
        const project = getProject((0, _projectConfig.getBaseDirFromFile)(filename));
        ...
        const mockGraphQLCall = t.callExpression(t.identifier('mockGraphQLQuery'), [t.stringLiteral(cell.queryOperationName), mockFunction]);
