...
const getNewPath = (value, filename) => {
  ...
  const basename = _path.default.basename(value);
  ...
  if ((0, _projectConfig.resolveFile)(_path.default.resolve(_path.default.dirname(filename), indexImportPath))) {
    ...
    if ((0, _projectConfig.resolveFile)(_path.default.resolve(_path.default.dirname(filename), dirnameImportPath))) {
