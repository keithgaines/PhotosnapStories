  ...
  return {
    ...
    visitor: {
      ImportDeclaration(p, state) {
        ...
        const importGlob = (0, _projectConfig.importStatementPath)(p.node.source.value);
        ...
        for (const filePath of dirFiles) {
          ...
          nodes.push(t.importDeclaration([t.importNamespaceSpecifier(t.identifier(importName + '_' + fpVarName))], t.stringLiteral(filePathWithoutExtension)));
