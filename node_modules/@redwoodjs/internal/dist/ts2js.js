...
exports.typeScriptSourceFiles = exports.transformTSToJS = exports.prettify = exports.prettierConfig = exports.convertTsScriptsToJs = exports.convertTsProjectToJs = exports.convertTsFilesToJs = void 0;
...
const convertTsFilesToJs = (cwd, files) => {
  if (files.length === 0) {
