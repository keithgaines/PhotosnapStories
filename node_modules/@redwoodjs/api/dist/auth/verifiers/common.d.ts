...
export declare const verifierLookup: {
    skipVerifier: (_options?: VerifyOptions | undefined) => SkipVerifier;
    secretKeyVerifier: (_options?: VerifyOptions | undefined) => SecretKeyVerifier;
    sha1Verifier: (_options?: VerifyOptions | undefined) => Sha1Verifier;
    sha256Verifier: (_options?: VerifyOptions | undefined) => Sha256Verifier;
    base64Sha1Verifier: (_options?: VerifyOptions | undefined) => Base64Sha1Verifier;
    base64Sha256Verifier: (_options?: VerifyOptions | undefined) => Base64Sha256Verifier;
    timestampSchemeVerifier: (options?: VerifyOptions | undefined) => TimestampSchemeVerifier;
    jwtVerifier: (options?: VerifyOptions | undefined) => JwtVerifier;
};
export type SupportedVerifiers = SkipVerifier | SecretKeyVerifier | Sha1Verifier | Sha256Verifier | Base64Sha1Verifier | Base64Sha256Verifier | Sha1Verifier | TimestampSchemeVerifier | JwtVerifier;
