 ...
 *  => { match: true, params: {} }
 */
export declare const matchPath: (route: string, pathname: string, { paramTypes, matchSubPaths, }?: {
    paramTypes?: Record<string, ParamType> | undefined;
    matchSubPaths?: boolean | undefined;
}) => {
    match: boolean;
    params?: undefined;
} | {
