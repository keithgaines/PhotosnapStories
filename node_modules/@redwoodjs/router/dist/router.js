...
function isRoute(node) {
  return /*#__PURE__*/(0, _react.isValidElement)(node) && node.type === Route;
}
const Router = _ref2 => {
  let {
    useAuth,
...
function analyzeRouterTree(children, pathname, paramTypes) {
  ...
  function isActiveRoute(route) {
    if (route.props.path) {
      const {
        match
      } = (0, _util.matchPath)(route.props.path, pathname, {
        paramTypes
      });
      if (match) {
        return true;
  ...
  function analyzeRouterTreeInternal(children) {
    ...
    return (0, _reduce.default)(_context = _react.default.Children.toArray(children)).call(_context, (previousValue, child) => {
      ...
      } else if ( /*#__PURE__*/(0, _react.isValidElement)(child) && child.props.children) {
