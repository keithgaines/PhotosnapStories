 ...
 *  => { match: true, params: {} }
 */
const matchPath = function (route, pathname) {
  var _context2;
  let {
    paramTypes,
    matchSubPaths
...
const validatePath = path => {
  ...
  if (/{(?:ref|key)(?::|})/.test(path)) {
    throw new Error([`Route contains ref or key as a path parameter: "${path}"`, "`ref` and `key` shouldn't be used as path parameters because they're special React props.", 'You can fix this by renaming the path parameter.'].join('\n'));
  }
